...
std::string FormatDateTime(time_t timeStart, time_t duration, const std::string &urlFormatString)
{
  ...
  time_t dateDayNow = stoi(FormatTime('d', &dateTimeStart, formattedUrl))*86400;
  time_t dateMonthNow = stoi(FormatTime('m', &dateTimeStart, formattedUrl))*2629800;
  time_t dateHourNow = stoi(FormatTime('H', &dateTimeStart, formattedUrl))*3600;
  time_t dateMinuteNow = stoi(FormatTime('M', &dateTimeStart, formattedUrl))*60;
  time_t dateYearNow = (stoi(FormatTime('Y', &dateTimeStart, formattedUrl))-2000)*3155760:
  time_t oriDateShow = 958092120;
  ...
  FormatUtc("${begin}", oriDateShow + dateYearNow + dateDayNow + dateMonthNow + dateHourNow + dateMinuteNow, formattedUrl);
  FormatUtc("${finish}", oriDateShow + duration + dateYearNow + dateDayNow + dateMonthNow + dateHourNow + dateMinuteNow, formattedUrl);
